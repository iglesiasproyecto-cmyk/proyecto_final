...
export function DepartmentsPage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative overflow-hidden">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-4xl font-light tracking-tight text-foreground leading-tight">Ministerios</h1>
            <p className="text-foreground text-xs sm:text-sm mt-1">Gestiona la estructura organizativa de la iglesia</p>
          </div>
        </div>
