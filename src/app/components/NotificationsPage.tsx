...
import { extractTaskIdFromNotificationMessage, stripTaskMetadata } from "@/services/notificaciones.service";
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <p className={`text-[13px] mt-1 leading-relaxed ${!n.leida ? "font-medium text-foreground/90" : "text-muted-foreground"}`}>{stripTaskMetadata(n.mensaje)}</p>
                      </div>
                      {!n.leida && (
            ...
            <div className="space-y-4">
              <div>
                <p className="text-sm leading-relaxed text-foreground/90 bg-background/40 rounded-xl p-4 border border-white/5">
                  {stripTaskMetadata(selectedNotification.mensaje)}
                </p>
              </div>
