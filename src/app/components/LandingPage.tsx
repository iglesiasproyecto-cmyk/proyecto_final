    ...
    <div ref={containerRef} className="bg-[#02060d] min-h-screen text-white font-sans selection:bg-blue-500/30 overflow-x-hidden relative">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden z-20">
        ...
        >
          ...
          <SEILogo 
            className="w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] md:w-[750px] md:h-[750px] lg:w-[1000px] lg:h-[1000px] drop-shadow-[0_0_100px_rgba(59,130,246,0.4)] contrast-110" 
            style={{ 
              imageRendering: "auto",
        ...
        >
          <p className="text-[10px] font-bold tracking-[0.4em] uppercase text-slate-500">Explorar</p>
          <motion.div 
            animate={{ y: [0, 10, 0] }}
      ...
      <section className="relative py-20 md:py-40 px-6 overflow-hidden z-20">
        <motion.div 
        ...
        >
          ...
          >
            <h1 className="text-5xl sm:text-7xl md:text-9xl lg:text-[130px] font-black leading-[0.85] tracking-tight md:tracking-tighter mb-12 md:mb-20 text-center w-full px-4 break-words">
              <span className="block w-full text-center">Liderazgo con</span>
              <span className="block w-full text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-white drop-shadow-[0_0_80px_rgba(59,130,246,0.5)]">
                Visión Técnica.
              </span>
            </h1>

            <p className="text-xl md:text-2xl lg:text-3xl text-slate-400 max-w-5xl mx-auto mb-16 md:mb-24 leading-relaxed font-medium text-center px-6 opacity-80">
            ...
            {/* Feature Cards */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 w-full max-w-6xl mb-16 md:mb-32 px-4">
              <GlassModule className="flex flex-col items-center text-center p-8 md:p-12 gap-6 border-white/5 hover:border-blue-500/30 transition-colors">
                <Globe className="w-8 h-8 md:w-12 md:h-12 text-blue-400 opacity-50" />
                <div className="space-y-2">
                  <div className="text-3xl md:text-5xl font-black">24/7</div>
                  <div className="text-[12px] font-bold uppercase tracking-widest text-slate-500">SOPORTE</div>
                </div>
              </GlassModule>
              <GlassModule className="flex flex-col items-center text-center p-8 md:p-12 gap-6 border-white/5 hover:border-blue-500/30 transition-colors">
                <Layers className="w-8 h-8 md:w-12 md:h-12 text-blue-400 opacity-50" />
                <div className="space-y-2">
                  <div className="text-3xl md:text-5xl font-black">Admin</div>
                  <div className="text-[12px] font-bold uppercase tracking-widest text-slate-500">MÓDULOS</div>
                </div>
              </GlassModule>
              <GlassModule className="flex flex-col items-center text-center p-8 md:p-12 gap-6 border-white/5 hover:border-blue-500/30 transition-colors">
                <Shield className="w-8 h-8 md:w-12 md:h-12 text-blue-400 opacity-50" />
                <div className="space-y-2">
                  <div className="text-3xl md:text-5xl font-black">Total</div>
                  <div className="text-[12px] font-bold uppercase tracking-widest text-slate-500">SEGURIDAD</div>
                </div>
              </GlassModule>
            </div>
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <GlassModule>
                  <div className="flex flex-col gap-4">
                    ...
                    <h4 className="text-xl font-bold">Datos Inteligentes</h4>
                ...
                <GlassModule>
                  <div className="flex flex-col gap-4">
                    ...
                    <h4 className="text-xl font-bold">Red de Ministerios</h4>
      ...
      <section className="py-20 md:py-40 px-6 bg-white/[0.01] border-y border-white/5">
        <div className="max-w-7xl mx-auto text-center mb-20">
          <h3 className="text-4xl md:text-5xl font-black mb-6">Tracción y Crecimiento</h3>
          <p className="text-slate-500 font-medium">Monitoreo histórico de expansión estructural.</p>
        </div>
        <div className="max-w-5xl mx-auto">
          <GlassModule className="flex flex-col md:flex-row items-center justify-between gap-12 p-12">
            <div className="text-left space-y-4">
              <div className="text-5xl font-black text-blue-400">+1.2k</div>
              <div className="text-sm font-bold uppercase tracking-widest text-slate-500">Nuevas Almas / Mes</div>
              <GrowthTimeline />
            </div>
            <div className="h-px w-full md:w-px md:h-32 bg-white/10" />
            <div className="text-left space-y-4">
              <div className="text-5xl font-black text-white">98%</div>
              <div className="text-sm font-bold uppercase tracking-widest text-slate-500">Efectividad Operativa</div>
              <div className="flex gap-1">
                {[...Array(5)].map((_, i) => <ShieldCheck key={i} className="w-5 h-5 text-blue-500" />)}
              </div>
            </div>
            <div className="h-px w-full md:w-px md:h-32 bg-white/10" />
            <div className="text-left space-y-4">
              <div className="text-5xl font-black text-cyan-400">12s</div>
              <div className="text-sm font-bold uppercase tracking-widest text-slate-500">Tiempo de Respuesta</div>
              <Activity className="w-12 h-12 text-cyan-500/50 animate-pulse" />
            </div>
          </GlassModule>
        </div>
      </section>
      ...
      <section className="py-20 md:py-40 px-6 relative overflow-hidden">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <h2 className="text-5xl font-black leading-tight">Expansión Territorial <br /><span className="text-blue-500">Geolocalizada.</span></h2>
            <p className="text-slate-400 text-lg leading-relaxed">Visualiza el alcance real de tus misiones y sedes con una precisión quirúrgica. S.E.I. mapea tu crecimiento para una mejor cobertura pastoral.</p>
            <Button className="rounded-full px-8 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold h-12">EXPLORAR MAPA</Button>
          </div>
        </div>
      </section>

      {/* --- CINEMATIC CTA --- */}
      <section className="py-20 md:py-60 px-6 text-center relative overflow-hidden">
        ...
        >
          <h2 className="text-4xl sm:text-6xl md:text-8xl font-black mb-12 tracking-tight md:tracking-tighter break-words px-4">
      ...
      <footer className="py-20 px-6 border-t border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
          <div className="flex items-center">
            <SEILogo className="w-32 h-32 md:w-48 md:h-48 opacity-40 hover:opacity-100 transition-opacity" />
          </div>
          ...
          <p className="text-[10px] font-bold text-slate-500 tracking-[0.5em] uppercase">
