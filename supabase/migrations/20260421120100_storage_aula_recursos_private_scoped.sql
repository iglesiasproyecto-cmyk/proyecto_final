...
-- SKIP: DROP POLICY IF EXISTS "Aula recursos read scoped" ON storage.objects;
-- SKIP: DROP POLICY IF EXISTS "Aula recursos insert scoped" ON storage.objects;
-- SKIP: DROP POLICY IF EXISTS "Aula recursos update scoped" ON storage.objects;
-- SKIP: DROP POLICY IF EXISTS "Aula recursos delete scoped" ON storage.objects;
...
-- SKIP: CREATE POLICY "Aula recursos read scoped"
...
-- SKIP: CREATE POLICY "Aula recursos insert scoped"
...
-- SKIP: CREATE POLICY "Aula recursos update scoped"
...
-- SKIP: CREATE POLICY "Aula recursos delete scoped"
...
-- SKIPPED: recurso table does not exist
